...
void main() {
  runApp(const Alzaanin());
}

class Alzaanin extends StatelessWidget {
  const Alzaanin({Key? key}) : super(key: key);

  static const appTitle = 'Assignment-2-(Abed ALzaanin Drawer)';
